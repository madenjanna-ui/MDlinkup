...
const API = {
    ...
    async groupMessages(id,limit=100) { return (await this.request(`/api/groups/${id}?limit=${limit}`)).messages; },
    ...
    async updateGroup(id,data) { return (await this.request(`/api/groups/${id}`,{method:"PUT",body:JSON.stringify(data)})).group; },
    ...
    async globalMessages(limit=100) { return (await this.request(`/api/messages/global?limit=${limit}`)).messages; },
    ...
    async privateMessages(id,limit=100) { return (await this.request(`/api/messages/private/${id}?limit=${limit}`)).messages; },
    ...
    async callIce() { return (await this.request("/api/calls/ice")).iceServers; },
